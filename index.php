                ...
                <div class="row">
                    <div class="col-lg-10 mx-auto mb-5">
                        ...
                        <iframe name="Iframe In Vitro 2" id="iframe-ECE"
                                ...
                                style="z-index: 100 !important; border:1px solid #e8e8e8; background: #e8e8e8">
                        </iframe>
            ...
            <div class="container text-center">
                <div class="row">
                    <div class="col-lg-10 mx-auto mb-5">
                        ...
                        <button class="btn-info btn-lg" id="btn-Evo" style="position: relative; top: 250px; float: top">
                            Run the game
                        </button>
                ...
                <div class="row">
                    <div class="col-lg-10 mx-auto mb-5">
                        ...
                        <button class="btn-info btn-lg" id="btn-EvoSand"
                                style="position: relative; top: 250px; float: top">
                            Run the game
                        </button>
            ...
            <div class="container text-center">
                <div class="row">
                    <div class="col-lg-10 mx-auto mb-5">
                        ...
                        <button class="btn-info btn-lg" id="btn-SFF" style="position: relative; top: 250px; float: top">
                            Run the game
                        </button>
                ...
                <div class="row">
                    <div class="col-lg-10 mx-auto mb-5">
                        ...
                        <iframe name="Iframe In Vitro 2" id="iframe-in-vitro"
                                ...
                                allowtransparency="true"
                                class="mb-4" width="100%" height="122%"
                                style="z-index: 100 !important; border:1px solid #e8e8e8;">
                        </iframe>
